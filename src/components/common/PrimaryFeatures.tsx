...
function DeviceUserIcon(props: React.ComponentProps<'svg'>) {
  return (
...
function DeviceNotificationIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#A3A3A3" fillOpacity={0.2} />
      <path
...
function DeviceTouchIcon(props: React.ComponentProps<'svg'>) {
  let id = useId();
